...
class DataManager {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "jp.fsap.AnyViewSample" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("AnyViewSample", withExtension: "momd")!
...
/*
    func create(entityModel: NSManagedObject) {
        let entityName: String = NSStringFromClass(entityModel.classForCoder).componentsSeparatedByString(".").last!
        Log(NSString(format: "entityName:%@", entityName))
    }
*/
    func save()->Void {
